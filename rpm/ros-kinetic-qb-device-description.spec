Name:           ros-kinetic-qb-device-description
Version:        1.0.8
Release:        0%{?dist}
Summary:        ROS qb_device_description package

Group:          Development/Libraries
License:        BSD 3-Clause
URL:            http://wiki.ros.org/qb_device_description
...
%description
This package contains a device-independent description utilities for qbrobotics®
devices.
