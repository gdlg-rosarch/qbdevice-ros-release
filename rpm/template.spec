Name:           ros-kinetic-qb-device-control
Version:        1.1.0
Release:        0%{?dist}
Summary:        ROS qb_device_control package

Group:          Development/Libraries
License:        BSD 3-Clause
URL:            http://wiki.ros.org/qb_device_control
...
%description
This package contains a device-independent control library for qbrobotics®
devices.
